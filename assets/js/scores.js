...
if (score.score == GOLD_TROPHY_SCORE) {
  ...
  return `<li class="high-score">${score.name} - ${score.score} - <i class="fas fa-guitar gold-color"></i></li>`;
  
} else if (score.score == SILVER_TROPHY_SCORE) {

  return `<li class="high-score">${score.name} - ${score.score} - <i class="fas fa-guitar silver-color"></i></li>`;

} else if (score.score == BRONZE_TROPHY_SCORE) {
  
  return `<li class="high-score">${score.name} - ${score.score} - <i class="fas fa-guitar bronze-color"></i></li>`;
